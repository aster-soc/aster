...
object PackageInformation {
	...
	val repo: String = appConfig.propertyOrNull("repo")?.getString() ?: "https://git.gay/aster/aster"
	val bugTracker: String =
		appConfig.propertyOrNull("bugTracker")?.getString() ?: "https://git.gay/aster/aster/issues"
}
